  ...
  return <main>
    ...
    <section id="top" className="relative min-h-[92svh] overflow-hidden bg-ink text-paper">
      ...
      <div className="relative z-10 flex min-h-[92svh] flex-col justify-end px-6 pb-16 lg:px-12 lg:pb-20">
        ...
        <motion.div {...reveal} transition={{ duration: .9, delay: .25 }} className="mt-8 flex flex-col gap-7 sm:flex-row sm:items-end sm:justify-between">
    ...
    <section id="films" className="relative min-h-[78vh] overflow-hidden text-paper"><img src={images.goaImage} alt="A destination wedding at sunset in Goa" loading="lazy" className="absolute inset-0 h-full w-full object-cover"/><div className="absolute inset-0 bg-ink/45"/><div className="relative z-10 flex min-h-[78vh] flex-col items-center justify-center px-6 text-center"><p className="text-[10px] uppercase tracking-[.25em]">Stories in motion</p><h2 className="mt-4 text-6xl md:text-9xl">A moving memory.</h2><Button variant="editorialOutline" size="icon" className="mt-10 h-16 w-16 rounded-full" aria-label="Play wedding film"><Play className="ml-1" /></Button><p className="mt-5 text-xs">Rohan & Ananya · Goa · 04:18</p></div></section>

  ...
  return (
    <section className="relative flex h-[100svh] w-full items-end overflow-hidden bg-ink">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pb-20 md:px-10 md:pb-24">
        ...
        >
          theSafira — Wedding Photography &amp; Films, Pune
        </motion.p>
        ...
        >
          Candid, cinematic wedding photography and films — capturing the
          people, the emotion and the unrepeatable moments of your day.
        </motion.p>

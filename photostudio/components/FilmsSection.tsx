  ...
  return (
    <section id="films" className="bg-ink px-6 py-28 text-paper md:px-10">
      <div className="mx-auto max-w-7xl">
        <Reveal>
          <p className="text-[13px] text-paper/50">Stories in Motion</p>
        ...
        <div className="mt-16 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
          {films.map((film, i) => (
            <Reveal key={film.id} delay={i * 0.06}>
              <button
              ...
              >
                <div className="relative aspect-video overflow-hidden bg-paper/5">
                  ...
                  <span className="absolute bottom-3 right-3 text-[11px] text-paper/80">
                    {film.duration}
                  </span>
                </div>
                <p className="mt-4 font-display text-lg">{film.title}</p>

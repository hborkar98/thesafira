...
export const stories: Story[] = [
  ...
  },
  {
    id: "7",
    title: "Kabir & Isha",
    slug: "kabir-and-isha-alibaug",
    category: "Couple",
    location: "Alibaug, Maharashtra",
    date: "2026-02-14",
    coverImage: img("kabir-isha-cover", 1600, 2000),
    excerpt: "A pre-wedding shoot on a working farm, because that's where they actually fell in love.",
    description:
      "Kabir and Isha didn't want a studio backdrop or a manufactured setting. They asked for the farm where they had their first date instead — mud, dogs, and all. This is what a couple shoot looks like when it's about the couple and not the props.",
    photoCount: 58,
    images: [
      { src: img("ki-1", 1800, 1200), alt: "Walking the farm road at golden hour", orientation: "wide" },
      { src: img("ki-2", 1200, 1600), alt: "Isha laughing at Kabir mid-sentence", orientation: "portrait" },
      { src: img("ki-3", 1200, 1600), alt: "Quiet moment by the well", orientation: "portrait", mono: true },
      { src: img("ki-4", 1600, 1067), alt: "The farm dogs joining the shoot", orientation: "landscape" },
    ],
    featured: false,
    tags: ["couple-shoot", "pre-wedding", "alibaug"],
  },
  {
    id: "6",
